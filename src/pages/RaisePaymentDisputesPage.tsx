        ...
        <>
            <div className="min-h-screen w-full bg-gray-100 flex justify-center">
                <div className="w-full min-h-screen bg-white rounded-md shadow-md">
                    <h2 className="text-xl text-[#3248d6] font-semibold p-6">Raise Payment Dispute</h2>
                        ...
                        <table className="w-full">
                            <thead className='bg-blue-50 shadow-inner '>
                                <tr className="text-left text-slate-600 text-[0.8rem] border-b border-slate-100 tracking-wide">
                                    <th className="ps-6 font-normal">DISPUTE ID</th>
                                    <th className="p-3 font-normal">SUBMITTED DATE</th>
                                    <th className="p-3 font-normal">DISPUTE STATUS</th>
                    ...
                    {isRaiseDisputeModalOpen && (
                        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
                            <div className="bg-white p-6 rounded-lg shadow-lg relative w-96">
                                ...
                                <h2 className="text-xl font-semibold mb-4 border-b pb-4">Raise Payment Dispute</h2>
                                ...
                                <label className='text-slate-900 text-md block mb-1'>Invoice Number</label>
                                <input
                                    type="text"
                                    value={location}
