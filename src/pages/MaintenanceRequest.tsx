        ...
        <>
            <div className="min-h-screen w-full bg-gray-100 flex justify-center">
                <div className="w-full min-h-screen bg-white rounded-md shadow-md">
                    <h2 className="text-xl text-[#3248d6] font-semibold p-6">Maintenance Request</h2>
                        ...
                        <table className="w-full">
                            <thead className='bg-blue-50 shadow-inner '>
                                <tr className="text-left text-slate-600 text-[0.8rem] border-b border-slate-100 tracking-wide">
                                    ...
                                    <th className="ps-6 font-normal">REQUEST ID</th>
                                    <th className="p-3 font-normal">REQUESTED DATE</th>
                                    <th className="p-3 font-normal">REQUEST STATUS</th>
                            ...
                            <tbody>
                                {currentItems.map((data, index) => (
                                    <tr key={index} className="border-b border-slate-100 hover:bg-gray-50">
                                        ...
                                        <td className="ps-6 font-medium text-slate-600">{data.requestID}</td>
                                        ...
                                        <td className="px-3 py-4 text-slate-600 font-normal cursor-pointer">
                                            <span className={`${statusColors[data.requestStatus]} px-3 py-1 text-sm rounded-full`}
                    ...
                    {isRaiseDisputeModalOpen && (
                        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
                            <div className="bg-white p-6 rounded-lg shadow-lg relative w-96">
                                ...
                                <h2 className="text-xl font-semibold mb-4 border-b pb-4">Maintenance Request</h2>
                                <label className='text-slate-900 text-md block mb-1'>Type of Issue</label>
                                <select
                                ...
                                />
                                {/* <label className='text-slate-700 block mb-2'>Upload Relevant Document</label>
                                <input
                                    type="file"
                                    // placeholder="Unit Name"
                                    value={location}
