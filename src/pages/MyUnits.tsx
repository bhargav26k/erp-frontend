...
const MyUnitsPage: FC = () => {
    const data: any[] = [
        {
            srNo: '1',
            organizationName: "Royal Realty",
            propertyName: "Gera's Imperium Rise",
            unitName: "A-Wing",
            location: "Hinjewadi, Pune",
            contractStartDate: "Jan 19,2025",
            contractEndDate: "Jan 19,2026",
            monthlyRent: "22,000",
            status: "Active",
        },
        {
            srNo: '2',
            organizationName: "BlueBridge Realty",
            propertyName: "Vidhya Heights",
            unitName: "B-Wing",
        ...
        {
            srNo: '3',
            organizationName: "Skyward Solutions",
            propertyName: "Swiss County",
            unitName: "A-Wing",
            location: "Warje, Pune",
            contractStartDate: "Jan 19,2025",
            contractEndDate: "Jan 19,2025",
            monthlyRent: "10,000",
            status: "Active",
        },
        {
        ...
        },
        {
            srNo: '5',
            organizationName: "Skyward Solutions",
            propertyName: "Vasundhara Heights",
            unitName: "C-Wing",
            location: "Mukai Chowk, Pune",
            contractStartDate: "Jan 19,2025",
            contractEndDate: "Jan 19,2025",
            monthlyRent: "20,000",
            status: "Inactive",
        ...
        <>
            <div className="min-h-screen w-full bg-gray-100 flex justify-center">
                <div className="w-full min-h-screen bg-white rounded-md shadow-md">
                    <h2 className="text-xl text-[#3248d6] font-semibold p-6">My Units</h2>
                        ...
                        <table className="w-full">
                            <thead className='bg-blue-50 shadow-inner '>
                                <tr className="text-left text-slate-600 text-[0.8rem] border-b border-slate-100 tracking-wide">
                                    ...
                                    <th className="p-3 font-normal">CONTRACT START DATE</th>
                                    <th className="p-3 font-normal">CONTRACT END DATE</th>
                            ...
                            <tbody>
                                {data.map((data, index) => (
                                    <tr key={index} className="border-b border-slate-100 hover:bg-gray-50">
                                        ...
                                        <td className="p-3 text-slate-600 font-light">{data.organizationName}</td>
                                        <td className="p-3 text-slate-600 font-light">{data.propertyName}</td>
                                        <td className="p-3 text-slate-600 font-light">{data.contractStartDate}</td>
                                        <td className="p-3 text-slate-600 font-light">{data.contractEndDate}</td>
                                        <td className="p-3 text-slate-600 font-light">₹{data.monthlyRent}</td>
                                        <td className="p-3 text-slate-600 font-normal">
                                            <span className={`${statusColors[data.status]} px-3 py-1 text-sm rounded-full`}
                                            >{data.status}</span>
                                        </td>
                                        <td className="p-3">
                                            {/* View (Eye) Button */}
