...
const UpdateTDSApplicableModal: React.FC<SplittableModalProps> = ({ isOpen, onClose, tenantId, onTenantUpdated }) => {
    ...
    const saveStatus = async () => {
          try {
                    ...
                    console.log("tds applicable" + tdsApplicable);
                    ...
                    setError("Failed to update tds applicable.");
                } finally {
                    setLoading(false);
                }
    };
    ...
    return (
        <div className="fixed inset-0 flex items-center justify-center bg-gray-800 bg-opacity-50">
            <div className="bg-white p-5 rounded-md shadow-md px-10 relative w-96">
                ...
                <h3 className="text-lg text-slate-800 font-bold mb-5">Is TDS Applicable?</h3>
                ...
                <label className="block mb-5 cursor-pointer">
                    <input
                        ...
                        className="hidden"
                    />
                    <span className={`px-4 py-1 text-sm rounded-full ${tdsApplicable === true ? "bg-blue-100 text-blue-700" : "bg-green-100 text-green-700"}`}>
                ...
                <label className="block mt-2 cursor-pointer">
                    <input
                        ...
                        className="hidden"
                    />
                    <span className={`px-4 py-1 text-sm rounded-full ${tdsApplicable === false ? "bg-blue-100 text-blue-700" : "bg-red-100 text-red-700"}`}>
...
export default UpdateTDSApplicableModal;
