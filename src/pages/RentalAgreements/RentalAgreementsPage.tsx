...
import { getAllActiveContracts, getAllContracts, getTenantById, updateContractStatus } from './core/_requests';
            ...
            <div className="min-h-screen w-full bg-gray-100 flex justify-center">
                <div className="w-full min-h-screen bg-white rounded-md shadow-md">
                                    ...
                                    (currentItems.map((contract, index) => (
                                        <tr key={contract.id} className="border-b border-slate-100 hover:bg-gray-50">
                                            ...
                                            {/* {(() => {
                                                ...
                                                const statusClass = contractStatus === "Active" ? "bg-green-200 text-green-800" : "bg-red-200 text-red-800";
                    ...
                    <AddRentalAgreementModal
                        ...
                        onContractAdded={fetchContracts} // Refresh table after adding
                    />
                </div>
            </div>
        </>
