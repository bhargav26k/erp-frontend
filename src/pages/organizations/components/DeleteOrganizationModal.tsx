...
import { deleteOrganization, getOrganizationById } from "../core/_requests";
...
const DeleteOrganizationModal: React.FC<DeleteOrganizationModalProps> = ({ isOpen, onClose, organizationId, onOrganizationDeleted }) => {
    ...
    const fetchOrganizationDetails = async () => {
        try {
            ...
            setOrganizationName(data.name);  // Fill input fields with fetched data
        } catch (err) {
    ...
    return (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
            <div className="bg-white p-6 rounded-lg shadow-lg relative">
                ...
                <p className="mt-2">
                    Are you sure you want to delete <strong>{organizationName || "this organization"}</strong>?
                </p>
