...
import { EditUploadedContent } from "../../modals/create-app-stepper/EditUploadedContent";
  ...
  useEffect(() => {
    ...
    const fetchUploads = async () => {
      ...
      try {
        ...
        console.log(queryParams, school_id, session_id);
        ...
        if (currentUser?.roleName === "Teacher") {
          ...
          response = await fetch(
            `${DOMAIN}/api/school/get-alluploadsbyid/${school_id}/${session_id}/?${queryParams}`
          );
        }
  ...
  const handleDelete = async (id) => {
    try {
        const response = await axios.post(
            `${DOMAIN}/api/school/delete-uploadcontent`,
            { id }
        );
