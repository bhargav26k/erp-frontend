...
import { AddSource } from "../../modals/create-app-stepper/AddSource";
import { toast } from "react-toastify";
import { DeleteConfirmationModal } from "../../modals/create-app-stepper/DeleteConfirmationModal";
import { CreateEditSource } from "../../modals/create-app-stepper/CreateEditSource";
...
const TablesWidget71 = () => {
  ...
  const handleDelete = async () => {
    try {
      const response = await fetch(
        `${DOMAIN}/api/school/delete-source/${sourceId}`,
        {
          method: "DELETE",
        }
      );
      ...
      toast.success("Source deleted successfully.", { autoClose: 3000 });
            ...
            {filteredData.map((item, index) => (
              ...
              >
                ...
                >
                  <div
                    onClick={() =>
                      handleModalEdit(item.id, item.source, item.description)
                    }
                    style={{
                      display: "flex",
                      alignItems: "center",
