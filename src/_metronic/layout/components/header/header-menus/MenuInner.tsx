...
export function MenuInner() {
  ...
  return (
    <>
      ...
      {/* <MenuItem title='Fee Dashboard' to='/fee-details' />
      <MenuItem title='Lead Dashboard' to='/lead-generation' />
      <MenuItem title='Income & Expenses' to='/income-expense' /> */}
      {/* <MenuInnerWithSub
        title='Crafted'
        to='/crafted'
      ...
      >
        ...
        >
          <MenuInnerWithSub
            ...
            menuTrigger={`{default:'click', lg: 'hover'}`}
          >
            <MenuItem to='/crafted/pages/profile/overview' title='Overviwe' hasBullet={true} />
