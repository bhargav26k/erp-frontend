...
const Input: FC<InputProps> = ({
    ...
    if (login) {
        ...
        if (disabled) {
            ...
            inputClasses += ` bg-transparent text-white/90 border-gray-300 focus:border-brand-300 focus:ring focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:focus:border-brand-800`;
